-- Rename the legacy product persistence objects into the reusable n2f namespace.
-- The migration runner executes this in one transaction. It preserves rows and
-- intentionally leaves public.signals_migrations as the compatibility ledger.
