...
MUTATIONS=[
    ("occurred_time_replaced", "src/modules/audit/index.ts", "occurredAtMs: wire.occurred_at_ms,", "occurredAtMs: recordedAtMs,"),
    ("receipt_consumer_scope_ignored", "src/modules/audit/index.ts", "this.mailbox.consume(this.consumer, async (tx, event) => {", "this.mailbox.consume('other', async (tx, event) => {"),
    ("audit_action_projection_bypassed", "src/modules/audit/index.ts", "action: wire.type,", "action: 'identity.fake.v1',"),
]
